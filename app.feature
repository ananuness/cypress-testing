...
Scenario: Submitting an image with invalid inputs
  ...
  Then I enter "" in the imageUrl field
  ...
  And I should see an exclamation icon in the title and imageUrl fields
...
Scenario: Submitting an image with valid inputs using enter key
  ...
  When I enter "https://cdn.mos.cms.futurecdn.net/eM9EvWyDxXcnQTTyH8c8p5-1200-80.jpg" in the imageUrl field
...
Scenario: Submitting an image and updating the list
  ...
  Then I have entered "https://cdn.mos.cms.futurecdn.net/eM9EvWyDxXcnQTTyH8c8p5-1200-80.jpg" in the imageUrl field
